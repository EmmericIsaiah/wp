...
function test_widgets_init2() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer-1', 'test1' ),
			'id'            => 'footer-1',
			'description'   => esc_html__( 'Add widgets here.', 'test1' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
...
add_action( 'widgets_init', 'test_widgets_init2' );

function test_widgets_init3() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer-2', 'test2' ),
			'id'            => 'footer-2',
			'description'   => esc_html__( 'Add widgets here.', 'test2' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
...
add_action( 'widgets_init', 'test_widgets_init3' );

function test_widgets_init4() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer-3', 'test3' ),
			'id'            => 'footer-3',
			'description'   => esc_html__( 'Add widgets here.', 'test3' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
...
add_action( 'widgets_init', 'test_widgets_init4' );
